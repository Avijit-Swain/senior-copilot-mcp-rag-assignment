/**
 * ABB wordmark, inlined as SVG so the shell renders with no network request
 * and no external asset in the Docker image.
 */
export function AbbLogo({ height = 18 }: { height?: number }) {
  return (
    <svg
      height={height}
      viewBox="-1 -1 88.2 35"
